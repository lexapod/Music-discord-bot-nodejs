export const botReplys = {
  trackOnPause: "⚠️Трек на паузе",
  wrongUrlProvided: "⚠️Попробуй подумать",
  musicResume: "✅Продолжаем бал",
  musicSteelPlaying: "⚠️Музыка и так играет",
  musicSteelPaused: "⚠️Музыка и так на паузе",
  nothingToSkip: "⚠️Нехуй скипать",
  icantSkipTrack: "⚠️Я немогу скипнуть трек пока он не играет.",
  ...
  unknownCommand: "⚠️Я не понял чо ты хочешь.",
};
